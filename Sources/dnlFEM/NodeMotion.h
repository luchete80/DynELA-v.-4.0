...
public:
  ...
  virtual void updateNode(double timeStep) = 0;
  virtual long getMotion() = 0;
  virtual void computeForces(double timeStep) = 0;
  //  virtual int Type()=0;
  //  virtual void computeContact(double timeStep)=0;
